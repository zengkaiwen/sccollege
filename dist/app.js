...
var store = Object(_store__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])();

var App = /*#__PURE__*/function (_Component) {
  Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(App, _Component);

  var _super = Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(App);

  function App() {
    Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(this, App);

    return _super.apply(this, arguments);
  }

  Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(App, [{
...
var config = {"pages":["pages/index/index","pages/notice/notice","pages/me/me","pages/user-school/user-school","pages/user-verify/user-verify","pages/user-home/user-home","pages/topic-maidan/topic-maidan","pages/topic-create/topic-create","pages/post-edit/post-edit","pages/post/post"],"window":{"backgroundTextStyle":"light","navigationBarBackgroundColor":"#fff","navigationBarTextStyle":"black"},"tabBar":{"color":"#13100e","selectedColor":"#13100e","backgroundColor":"#ffffff","borderStyle":"white","list":[{"pagePath":"pages/index/index","text":"社区","iconPath":"images/ic_community_line.png","selectedIconPath":"images/ic_community_full.png"},{"pagePath":"pages/notice/notice","text":"消息","iconPath":"images/ic_notice_line.png","selectedIconPath":"images/ic_notice_full.png"},{"pagePath":"pages/me/me","text":"我的","iconPath":"images/ic_me_line.png","selectedIconPath":"images/ic_me_full.png"}]},"subPackages":[{"root":"pages/subPackage/","pages":["comment/comment","topic-home/topic-home","notice-list/notice-list","user-edit/user-edit"]}]};
...
var INIT_STATE = _tarojs_taro__WEBPACK_IMPORTED_MODULE_0___default.a.getSystemInfoSync();
function appinfo() {
...
/* harmony import */ var _constants_hometabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constants/hometabs */ "./src/constants/hometabs.js");
...
function hometabs() {
  ...
  switch (action.type) {
    case _constants_hometabs__WEBPACK_IMPORTED_MODULE_1__[/* TAB_CHANGE */ "a"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
...
/* harmony import */ var _appinfo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./appinfo */ "./src/reducers/appinfo.js");
/* harmony import */ var _hometabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hometabs */ "./src/reducers/hometabs.js");
/* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user */ "./src/reducers/user.js");




/* harmony default export */ __webpack_exports__["a"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__[/* combineReducers */ "c"])({
  appinfo: _appinfo__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"],
  hometabs: _hometabs__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"],
  user: _user__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]
}));
...
var InitState = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default.a.getStorageSync('user');
function user() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : InitState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* INIT_USER */ "k"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), action.user);

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_AVATAR */ "a"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        avatar: action.avatar
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_NICKNAME */ "g"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        user_nickname: action.user_nickname
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_BIRTHDAY */ "b"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        birthday: action.birthday
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_DEGREE */ "c"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        degree: action.degree
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_HOMETOWN */ "d"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        province: action.province,
        city: action.city
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_ISAUTH */ "e"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        is_auth: action.is_auth
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_LABEL */ "f"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        label: action.label
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_PATHET_STATE */ "h"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        pathet_state: action.pathet_state
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_SCHOOL_YEAR */ "j"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
        school_year: action.school_year
      });

    case _constants_user__WEBPACK_IMPORTED_MODULE_2__[/* CHANGE_SCHOOL */ "i"]:
      return Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state), {}, {
...
var composeEnhancers = (typeof window === "undefined" ? "undefined" : Object(_Users_zengkaiwen_Documents_workspace_sccollege_taro3_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(window)) === 'object' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({// Specify extension’s options like name, actionsBlacklist, actionsCreators, serialize...
